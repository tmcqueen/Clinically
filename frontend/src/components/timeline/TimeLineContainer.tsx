    ...
    (event: DragEndEvent) => {
      ...
      if (!isValid && conflictingEventInfo) {
        ...
        setPendingDrop({
          ...
          originalProviderId: dragState.originalProviderId ?? undefined,
          originalStartMinutes: dragState.originalStartMinutes ?? undefined,
          originalEndMinutes: dragState.originalEndMinutes ?? undefined,
        });
  ...
  const handleConflictResolve = useCallback(
    (option: ConflictResolutionOption) => {
      ...
      if (option === "force") {
        ...
        if (originalProviderId && originalStartMinutes !== undefined && originalEndMinutes !== undefined) {
